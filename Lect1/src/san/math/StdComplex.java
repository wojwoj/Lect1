...
class StdComplex extends Complex {
	...
	public Complex multiply(Complex other) {
		return new StdComplex(this.re()*other.re() -this.im()*other.im() , this.re()*other.im()+this.im()*other.re());
	}

	@Override
	public Complex devide(Complex other) {	
		return new StdComplex(this.multiply(other.conjugate()).re()/(other.multiply(other.conjugate()).re()), this.multiply(other.conjugate()).im()/(other.multiply(other.conjugate())).re());
	}

	@Override
	public Complex conjugate() {
		return new StdComplex(this.re(), this.im()*(-1));
	}
